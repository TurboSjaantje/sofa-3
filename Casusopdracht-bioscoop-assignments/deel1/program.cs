...
var movieTicket4 = new MovieTicket(1, 1, false, new MovieScreening(DateTime.Now.AddDays(1), 10, new Movie("test")));
...
//First order
Console.WriteLine("Expected price of order 1: " + 12);
Console.WriteLine($"Order 1: {order1.CalculatePrice().ToString("F2")}");

//Second order
Console.WriteLine("Expected prive of order 2: " + 23);
